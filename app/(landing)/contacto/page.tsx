    ...
    <div className="max-w-2xl mx-auto px-4 py-24">
      ...
      <div className="space-y-4">
        <a
          ...
          className="flex items-center gap-5 rounded-2xl border border-emerald-300/25 bg-emerald-600/[0.04] p-6 hover:bg-emerald-600/[0.07] hover:border-emerald-300/40 transition-all group"
        >
          <div className="w-12 h-12 rounded-xl bg-emerald-600/15 flex items-center justify-center shrink-0">
          ...
          <span className="text-[13px] font-semibold text-emerald-600 group-hover:text-emerald-600 transition-colors">
            Escribir →
          </span>
        </a>
      ...
      <div className="mt-10 rounded-xl border border-white/[0.05] bg-white/[0.01] p-5 text-center">
        <p className="text-[13px] text-[#5a6480]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-emerald-600 hover:text-emerald-600 underline underline-offset-2"
          >
